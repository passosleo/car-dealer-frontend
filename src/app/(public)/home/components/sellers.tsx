...
import { SellersSkeleton } from "./skeletons/sellers-skeleton";

export function Sellers() {
  const maxSellersToShow = 2;
  const { sellers, isPending } = useListActiveSellersService({
    page: 1,
    limit: maxSellersToShow,
  });
  return (
    <Section bgColor="zinc-950" id="sellers">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {isPending ? (
          <SellersSkeleton count={maxSellersToShow} />
        ) : (
