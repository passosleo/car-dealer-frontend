...
import { SellerAvatar } from "@/app/admin/(private)/sellers/components/seller/seller-avatar";
...
const employees = [
  {
    ...
    phone: '11999999999',
    message: 'Olá, vim através do site da empresa e gostaria de saber mais sobre...',
    ...
    <Section bgColor="zinc-950" id="sellers">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300">Entre em contato com a nossa equipe de vendas</p>
        </div>

        <div className="flex flex-wrap gap-8 justify-center">
          {employees.map((employee) => (
            <div key={employee.id} className="bg-zinc-900 rounded-lg shadow-md px-4 py-7 flex flex-col items-center transition-transform transform hover:scale-105 max-w-64">
              ...
              >
                <WhatsappIcon className="w-5 h-5 inline-block" /> Falar com {employee.firstName}
              </a>
            </div>
          ))}
        </div>
